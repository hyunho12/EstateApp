...
namespace EstateWebApi.Migrations
{
    ...
    [Migration("20230807065615_initalize")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EstateV1App.Models.PropertyDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EstateWebApi.Models.Bookmark", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EstateWebApi.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EstateWebApi.Models.RealProperty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EstateWebApi.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EstateWebApi.Models.Bookmark", b =>
                {
                    b.HasOne("EstateWebApi.Models.RealProperty", "Property")
                        .WithMany("Bookmarks")
                        .HasForeignKey("RealPropertyId")
            ...
            modelBuilder.Entity("EstateWebApi.Models.RealProperty", b =>
                {
                    b.HasOne("EstateWebApi.Models.Category", "Category")
                        .WithMany("RealProperties")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EstateWebApi.Models.User", "User")
                        .WithMany()
