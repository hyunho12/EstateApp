...
namespace EstateWebApi.Data
{
    public class ApiDbContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Server=TSW\SQLEXPRESS;Database=RealEstate;Trusted_Connection=True;");
        }
